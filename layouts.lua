local function setLayout(self, layout)
    if layout == 1 then
        self._layout = 1
        love.window.setMode(
            self._size * 6 + self._ssize * 2 + self._bsize,
        ...
        self._h_rects = {
            ...
            { self._size + self._bsize, self._size + self._bsize },
            { self._size + self._bsize, self._size * 2 + self._bsize },
            { self._size + self._bsize, self._size * 3 + self._bsize },
        }

        self._m_rects = {
            { self._size * 2 + self._bsize + self._ssize, self._bsize },
            {
                self._size * 2 + self._bsize + self._ssize,
            ...
            { self._size * 3 + self._bsize + self._ssize, self._bsize },
            {
                self._size * 3 + self._bsize + self._ssize,
                self._size + self._bsize,
            },
            {
                self._size * 3 + self._bsize + self._ssize,
        ...
        self._s_rects = {
            { self._size * 4 + self._bsize + self._ssize * 2, self._bsize },
            {
                self._size * 4 + self._bsize + self._ssize * 2,
                self._size + self._bsize,
            },
            {
                self._size * 4 + self._bsize + self._ssize * 2,
            ...
            { self._size * 5 + self._bsize + self._ssize * 2, self._bsize },
            {
                self._size * 5 + self._bsize + self._ssize * 2,
                self._size + self._bsize,
            },
            {
                self._size * 5 + self._bsize + self._ssize * 2,
    ...
    if layout == 2 then
        self._layout = 2
        love.window.setMode(
            self._size * 3 + self._ssize * 2 + self._bsize,
